...
export interface SocialPetAccountInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "executeCall"
      | "isValidSignature"
...
export interface SocialPetAccount extends BaseContract {
  connect(runner?: ContractRunner | null): SocialPetAccount;
  waitForDeployment(): Promise<this>;

  interface: SocialPetAccountInterface;
